...
class vehiculo
{
    ...
    <div class="d-flex justify-content-between mb-3">
		...
		<table class="table table-bordered table-hover">
				...
				<tr>
					<th colspan="2"><input type="submit" name="Guardar" value="GUARDAR" class="btn btn-success"></th>
				</tr>			
				<tr>
						<th colspan="2"><a href="index.php" class="btn btn-primary">Regresar</a></th>
					</tr>									
			</table>
			</div>';
		return $html;
    ...
    <div class="d-flex justify-content-between mb-3">
		...
		<a href="index.php?d=' . $d_new_final . '" class="btn btn-success">Nuevo</a>
		<br>
		<br>
		...
		while ($row = $res->fetch_assoc()) {
			...
			$html .= '
				<tr>
					...
					<td>' . $row['anio'] . '</td>
					<td>' . $row['avaluo'] . '</td>
					<td><a href="index.php?d=' . $d_del_final . '" class="btn btn-danger">Borrar</a></td>
					<td><a href="index.php?d=' . $d_act_final . '" class="btn btn-warning">Actualizar</a></td>
					<td><a href="index.php?d=' . $d_det_final . '" class="btn btn-info">Detalle</a></td>
				</tr>
				        </tbody>';
		}
		$html .= '  
...
';
	...
	private function _message_error($tipo)
	{
		...
		<table border="0" align="center">
			...
			<tr>
				<th><a href="index.php" class="btn btn-primary">Regresar</a></th>
			</tr>
		</table>';
		return $html;
	}
